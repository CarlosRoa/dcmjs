...
class Normalizer {
    ...
    static normalizerForSOPClassUID(sopClassUID) {
        ...
        sopClassUIDMap[toUID.ComputedRadiographyImageStorage] = MRImageNormalizer;
...
class ImageNormalizer extends Normalizer {
    ...
    convertToMultiframe() {
        ...
        if(referenceDataset.ImageOrientationPatient) {
            rowVector = referenceDataset.ImageOrientationPatient.slice(0, 3) || null;
            columnVector = referenceDataset.ImageOrientationPatient.slice(3, 6) || null;
        } else {
            rowVector = null
            columnVector = null     
        }
